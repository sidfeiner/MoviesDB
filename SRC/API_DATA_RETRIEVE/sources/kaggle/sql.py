...
insert ignore into movies.movies(id, adult, budget_usd, original_language, original_title_id, overview, popularity,
...
insert ignore into movies.movie_spoken_languages(movie_id, language_id)
select movie_id, l.id
from temp_movie_spoken_languages m
         left join movies.languages l on l.language = m.language;

insert ignore into movies.movie_production_countries(movie_id, country_id)
select movie_id, c.id
from temp_movie_production_countries m
         left join movies.countries c on m.country = c.country_name;


insert ignore into movies.movie_production_companies(movie_id, production_company_id)
select movie_id, c.id
...
insert ignore into movies.movie_genres(movie_id, genre_id)
